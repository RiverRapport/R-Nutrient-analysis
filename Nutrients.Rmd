...
draw(TPM3,  select = 12,  residuals = TRUE,
...
```{r TP GAM plots, warning=F,message=F}
...
## TN GAMs
```{r TN GAM model building, warning=F,message=F}
#Try base model
TNM1 <-
  gam(
...
tn_temp.gam_sections<-ggarrange(t_year_CA,t_year_LSF,
                                labels=c("Cornwall","Lake St. Francis"),
                                nrow=2,vjust=0.2)+
  theme(plot.margin = margin(10,1,1,1))
